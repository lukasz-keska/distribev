        ...
        <?php foreach($categories as $cat): ?>
            <div class="container">
                <div class="brand-content slide-list-content row<?=(($cid==$cat->category_id)?' active':'');?>">
                    ...
                    <span class="logo"><?php if($cat->filebrand->hasImage()):?><img src="<?=$cat->filebrand->getUrl('original')?>"><?php endif; ?></span>
                </div>
                <div class="brand-products slide-el-content row"<?=(($cid==$cat->category_id)?'':' style="display:none;"');?><?php if($cat->filebanner->hasImage()): ?> data-banner="<?=$cat->filebanner->getUrl('original')?>"<?php endif;?>>     
