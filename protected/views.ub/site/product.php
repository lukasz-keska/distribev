    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-12">
                 <img src="<?=$product->file->getUrl('large')?>" />
            </div>
                ...
                <div class="row product-description mt-4 pr-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row product-options">
                            ...
                            <?php if($product->fileupload->hasFile()): ?><div class="col-sm-6 download"><a href="<?=$product->fileupload->getFileUrl()?>">Pobierz kartę produktu <i class="fa fa-download" aria-hidden="true"></i></a></div><?php endif; ?>
                        </div>
                    </div>
            ...
            <?php foreach($products as $i=>$p): ?>
                <div class="col-md-3 col-12 other-products-list<?php if($i>0 && isset($products[$i+1])): ?> other-products-list-border-a<?php endif; ?>">
                    <a href="/produkt.html?id=<?=$p->product_id?>">
                        <img src="<?=$p->file->getUrl('thumb'); ?>" style="height:225px;" />
                        <p><?=$p->title; ?></p>
                    </a>
                </div>
            <?php endforeach; ?>
