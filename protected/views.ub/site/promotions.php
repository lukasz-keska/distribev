...
<div id="content" class="content-bg">
            ...
            <div class="d-flex flex-md-row flex-column pb-5">
                ...
                <div class="col-md-4 col-12 img-adjust">
                    <a href="<?=Yii::app()->controller->createUrl('site/promotions',['id'=>398])?>">
                        <div class="img-text">
                            Horeca
                        </div>
                        <div class="img-prom-horeca"></div>
                    </a>
                </div>
                
                
                <div class="col-md-4 col-12 img-adjust">
                    <a href="<?=Yii::app()->controller->createUrl('site/b2b')?>">
                        <div class="img-text">
                            Sprzedaż bezpośrednia - 
                            oferta b2b
                        </div>
                        <div class="img-prom-b2b"></div>
                    </a>
                </div>
