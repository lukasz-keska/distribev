                ...
                <div class="row pt-5 pb-5">
                    <div class="col-md-4 col-12 text-center">
                        <div class="d-flex flex-column">
                            ...
                            <p class="pt-3">Zatrudnienie na podstawie<br /><strong>umowy o pracę</strong></p>
                        </div>
                    </div>
                    <div class="col-md-4 col-12 text-center">
                        <div class="d-flex flex-column">
                    ...
                    <div class="col-md-6 col-12 text-center cols-width">
                     <div class="d-flex flex-column">
                          <div class="fa-stacks fa-3x guarantee-el">
                            ...
                            <p class="pt-3"><strong>Stabilność</br>zatrudnienia</strong></p>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 text-center cols-width">
                     <div class="d-flex flex-column">
                          <div class="fa-stacks fa-3x guarantee-el">
                            ...
                            <p class="pt-3"><strong>Pakiety socjalne</strong>, m.in. dofinansowanie<br />ubezpieczenia na zycie, karty multisport</p>
                      </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="container award-icon-pos">
            <img src="/gfx/career/award.svg" />
                ...
                <h2 class="gray-sections-title">NAJWAŻNIEJSZE STANDARDY </br>PROCESÓW REKRUTACYJNYCH</h2>
        ...
        <div class="container career-list">
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">Event Manager</span>
                </div>
                
                <div class="career-description slide-el-content row" style="display:none;">
                    <div class="col-margin"></div>
                    <div class="text col-sm-10">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ac efficitur mi. Vestibulum viverra nisl sit amet arcu fringilla, sit amet accumsan lacus laoreet. Aenean eget nisi neque. Integer nec arcu vel eros gravida egestas. Nunc nec ultricies lacus, vulputate commodo erat. Fusce arcu diam, sagittis in ullamcorper et, blandit at eros. Aenean at felis in lacus ultrices tempus non et tortor.
                            <br />
                        Donec suscipit id purus quis vulputate. Nunc et egestas massa. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aenean sed cursus libero. Suspendisse sollicitudin tincidunt porttitor. In maximus nisl ut nisl accumsan interdum. Vestibulum egestas, mauris sed sollicitudin lacinia, quam enim commodo lectus, id porta mi sapien vel libero. Vestibulum accumsan vulputate mollis. In egestas, nulla sed mattis euismod, lorem dui laoreet dui, quis pulvinar leo magna a diam. Pellentesque pretium libero nec lectus ornare pulvinar. Pellentesque et urna laoreet, tristique tortor at, tincidunt erat.
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">Project Manager</span>
                </div>
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">Marketing Manager</span>
                </div>
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">Graphic Designer</span>
                </div>
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">Office Manager</span>
                </div>
            ...
            <div class="container">
                <div class="career-content slide-list-content row">
                    <span class="plus"><i class="fas fa-plus"></i></span>
                    <span class="name col">PR Manager</span>
                </div>
