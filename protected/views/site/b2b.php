...
<p class="main-description"><p>W United Beverages będąc jednym z największych dystrybutorów alkoholi w Polsce, zgromadziliśmy w swojej ofercie szeroką gamę win i alkoholi mocnych od czołowych producentów krajowych oraz renomowane światowe marki. Nasz profesjonalny i doświadczony zespół,  chętnie pomoże we właściwym wyborze.
</p>
        <p>Skontaktuj się z <a href="/sklepy.html">Biurem Obsługi Klienta</a> w wybranym oddziale.</p>
            <h3 class="mt-5">
                        Kolekcje upominkowe </h3>
        </div>
 <div class="row">
            <div class="col-md-7 col-12">
                    <p class="main-description"><p>Upominek z winem lub wykwintnym alkoholem jest bardzo uniwersalny na każda okazję. Oferujemy gotowe kolekcje upominkowe w gustownych opakowaniach z ciekawymi i użytecznymi dodatkami.
</p>
          
    <a href="http://www.unitedbeverages.pl/KatalogSwiateczny2019.pdf" class="btn btn-primary offer-btn">Poznaj pełną ofertę <i class="fas fa-arrow-right"></i> </a>
                 <p class="main-description"><p>Dla naszych wymagających klientów oferujemy szereg usług związanych z przygotowaniem oryginalnego upominku. Poczynając od ciekawie opakowanych pojedynczych butelek, po atrakcyjne kosze z winem, markowym alkoholem uzupełnionymi miłym dodatkiem. Wspaniały wybór dla klientów firmy, pracowników lub inne okazje.
</p>
              <p class="main-description"><p>Masz pytania, chcesz poznać ofertę handlową? Napisz do nas >>> <a href="mailto:upominki@unitedbeverages.pl">upominki@unitedbeverages.pl</a>
</p>
            </div>
